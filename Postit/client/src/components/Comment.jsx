        ...
        <div className="card-body">
          ...
          <div className="d-flex justify-content-between align-items-center">
            <div className="btn-group">
              <Link type="button" to="/posts" state={{}} className="btn btn-sm btn-outline-secondary">View Posts</Link>
              <Link type="button" to="/subpostit/edit" state={{}} className="btn btn-sm btn-outline-secondary">Edit</Link>
              <Link type="button" to="/subpostit/delete" state={{}} className="btn btn-sm btn-outline-secondary">Delete</Link>
            </div>
          </div>
        </div>  
      </div>
